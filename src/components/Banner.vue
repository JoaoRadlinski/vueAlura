<template>
    ...
    <div class="apresetacao">
      ...
      <p class="subtitulo-lg">
        Expore novas receitas todos os dias com os ingredientes que estão ao seu alcance.
      </p>
    </div>

    <img src="../assets/images/foto-banner.png" alt="foto cozinhando" class="foto-banner">
  </header>
</template>
